...
namespace Hotel_Manager.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Capacity,PricePerNight")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Capacity,PricePerNight")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
